...
class CMSSignatureService
{
    ...
    public function __construct($certificatePath, $privateKeyPath, $privateKeyPass) {
    ...
    public function signData($data) {
        ...
        openssl_cms_sign($tmpFileDataPath,$tmpFileSignaturePath,$certificatePath,
            array($privateKeyPath, $privateKeyPass), $headers, OPENSSL_CMS_DETACHED,OPENSSL_ENCODING_DER   );
